      ...
      <div class="container">
            <form>
                <div>
                    ...
                    <input @change="inputFirstname" @keyup="inputFirstname" type="text" name="firstName" id="firstName" placeholder="Comment vous appellez-vous ?"/>                    
                </div>                           
                <div>
                    <label for="lastName"> Nom </label>
                    <input @change="inputLastname" @keyup="inputLastname" type="text" name="lastName" id="lastName" placeholder="Quel est votre nom ?"/>
                </div>
                <div>
                    <label for="job"> Poste </label>
                    <input @change="inputJob" @keyup="inputJob" type="text" name="job" id="job" placeholder="Que faites-vous chez Groupomania ?"/>
                 </div>
                <div>
                    <label for="email"> Email </label>
                    <input @change="inputEmail" type="text" name="email" id="email" placeholder="Quel est votre email professionel ?"/>
                </div>
                <div>
                    <label for="password"> Mot de passe </label>
                    <input @change="inputPassword" type="password" name="password" id="password" placeholder="Choisissez un mot de passe"/>
                </div>
                <div>
                    <label for="passwordConfirm"> Confirmation mot de passe </label>
                    <input @change="inputConfirm" type="password" name="passwordConfirm" id="passwordConfirm" placeholder="Confirmez le mot de passe"/>
                </div>
...
no space, 
minumum an uppercase, 
a lowercase, a number 
...
export default {
  ...
  methods: {
      ...
      sendForm: function() {
          ...
          axios.post("http://localhost:3000/api/auth/signup", this.signupData)
          .then("💾 Utilisateur enregistré ✔️")
